...
<div class="bg-gradient-to-tr from-blue-50 via-purple-50 to-blue-100 rounded-2xl shadow-xl p-8 border border-blue-100 max-w-4xl mx-auto mt-10">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            ...
            <div class="text-xl font-extrabold text-gray-800">{{ $movement->stock->article }}</div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <span class="block text-lg font-bold text-gray-800">{{ $movement->created_at->format('d/m/Y H:i') }}</span>
            </div>
        </div>
